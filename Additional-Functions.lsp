...
(defun PntNLbl(m1 m2 m3 m4 m5 / lp2 xc yc pntm1 pntm2 cnt e mul mg outN outFsaveF lin coordF ch lp em pnt1 pnt2 pnt3 pntb pntf a b dis x y linN ss numStr wrt os num rAng sel fP fN i filP chk unN)
	(setq lp 1)
	(setq lp2 1)
	(setq em 0)
	(setq chk 1)
			...
			(progn
				...
				(if (and (= lp 1) (= m2 1))
					(progn
						...
						(print "dis, rAng, a, b, pntf")
						(print dis)
						(print tAng)
						(print a)
						(print b)
						(print (rtos (car pntf) 2 3))
						(print (rtos (cadr pntf) 2 3))
...
(defun c:chngHt( / numStr)
	...
	(writeToSaveFile nil (rtos nwH) nil nil nil nil nil nil nil nil)
	(setq q (getYN "Would you like a label border? [Y/N]: "))
	(setq tss (car tss))
