...
(defun PntNLbl(m1 m2 m3 m4 m5 / lp2 xc yc pntm1 pntm2 cnt e mul mg outN outFsaveF lin coordF ch lp em pnt1 pnt2 pnt3 pntb pntf a b dis x y linN ss numStr wrt os num rAng sel fP fN i filP chk)
	(setq lp 1)
	(setq lp2 1)
	(setq em 0)
	(setq chk 1)
